...
**Note** The custom theme is also available in the test files, just navigate your browser to the index of the `/test` directory and select your theme from the Dropdown menu. Para esto hay que montar un http server, en Ubuntu se puede hacer con: python -m SimpleHTTPServer 8000.
